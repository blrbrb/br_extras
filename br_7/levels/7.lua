...
br_core.register_level({
    level = 7,          -- actual index of the level, will overwrite any level of the same name
    desc = S("Level 7"),
...
br_core.register_biome({
    level = 7,
    desc = S("Level 7 Endless Sea"),
    danger = 0,                  -- not used yet either, see above
    segheight = 16,              -- how high the schematics are (use smallest size and then skip_above to do complex stuff)
    ...
    schems = {
        ...
        { name = sch("7_rooms_0"), prevalence = 4, vertical_segments = { 0, 1 } },
...
br_core.achievements.register_default(7)
